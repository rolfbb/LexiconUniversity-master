...
namespace LexiconUniversity.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Grade,CourseId,StudentId")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Grade,CourseId,StudentId")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
